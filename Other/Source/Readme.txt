...
user in an INI file next to GreenfishIconEditorProPortable.exe called
GreenfishIconEditorProPortable.ini. If you are happy with the default options,
...
directory to GreenfishIconEditorProPortable.ini next to
GreenfishIconEditorProPortable.exe. The options in the INI file are as follows:
